...
default setting, if using 127.0.0.1 it will throw  java.net.ConnectException
sometimes..
So we should use exatcly Ip address for the machine , or we can use
beijing to replace with the 128.59.15.30 if the clic machine we are using is
beijing. So the easily way to invoke will be like: 
	Receiver:
		java Receiver file2.txt 41194 beijing 41195 
	Sender:
		java Sender file.txt 128.59.15.30 41192 41195 logfileSend.txt 4
	Proxy:
		./newudpl -ibeijing -obeijing -v -L99 -B90000 -O9 -d1 
